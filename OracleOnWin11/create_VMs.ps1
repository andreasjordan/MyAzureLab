...
foreach ($computerName in $vmConfig.Keys) {
    ...
    Send-MyAzureLabStatus -Message "Creating virtual maschine $computerName"
...
Send-MyAzureLabStatus -Message "Finished deployment after $([int]$deploymentDuration.TotalMinutes) minutes"
